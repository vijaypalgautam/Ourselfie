...
<form class="modal-content animate" action="API/userLogin.php" method="POST" enctype="multipart/form-data">  
  <div class="container">
    <div style="color:red;">
           <?php
      ...
      <label for="gender"><b>Gender <i> *</i></b></label>
      ...
      <label for="mobile"><b>Mobile number<i> *</i></b></label>
        <select name="cCode" id="">
          <option data-countryCode="IN" value="91" Selected required>India (+91)</option>
      ...
      <label for="userId"><b>User Id<i> *</i></b></label>
        <input type="text" name="userId" placeholder="Enter your User Id" required><br>
      ...
      <input type="text" name="signup" value="3" hidden>
